			...
			<div class="row">
							...
							<table>
								<tbody>
									<tr>
										...
										<td style="width: 120px;"><div class="price text-center">$552</div></td>
										<td style="width: 120px;"><div class="remove text-center"><a href="javascript:void(0)"><i class="fa fa-times"></i></a></div></td>
									</tr>
									<tr>
										<td>
											<div class="order-prd">
				...
				<div class="col-md-4">
					<div class="box-cart-total">
						<div class="title text-center" style="margin-bottom: 0;">Tổng tiền</div>
						<ul>
							<li>
								<p>Tạm tính</p>
								<p>$300</p>
						...
						<div class="addto-cart  text-center"><a href="checkout.php" style="width: 100%;">PROCEED TO CHECKOUT</a></div>
					</div>
				</div>
			</div>
		</div>
